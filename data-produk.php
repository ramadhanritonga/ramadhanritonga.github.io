			...
			<div class="box">
				...
				<table border="1" cellspacing="0" class="table">
					...
					<tbody>
						<?php
						$no = 1;
							$produk = mysqli_query($conn, "SELECT * FROM tbl_product LEFT JOIN tbl_category USING (category_id)ORDER BY product_id DESC");
						...
						<tr> 
							...
							<img src="produk/<?php echo $row['product_image'] ?>" width="80px"></td></a>
